...
if (!_url)     throw new Error("Falta SUPABASE_URL en variables de entorno (chofer/billetera)");
if (!_roleKey) throw new Error("Falta SUPABASE_SERVICE_ROLE_KEY en variables de entorno (chofer/billetera)");
...
export async function GET(req: Request) {
  ...
  if (error) {
    console.error("[chofer/billetera] error leyendo billetera_chofer:", error.message);
