    ...
    <main className="min-h-screen bg-black text-white px-4 py-10">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <Section titulo="10. Derechos ARCO — Ley 25.326">
          ...
          <p className="mt-2">Para ejercer estos derechos, enviar una solicitud escrita a: <strong className="text-yellow-400">[EMAIL LEGAL]</strong> indicando nombre completo, DNI y el derecho que desea ejercer. La solicitud será respondida dentro del plazo legal vigente.</p>
        ...
        <Section titulo="13. Contacto">
          <p>Para consultas sobre privacidad y protección de datos personales, contactar a: <strong className="text-yellow-400">[EMAIL LEGAL]</strong></p>
        </Section>
